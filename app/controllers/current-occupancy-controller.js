app.controller('currentOccupancyController', function($scope, $location, $http, appConfig, $rootScope, $cookieStore, locationService){
	...
	$scope.currentPermits = function(){
		...
		$http({
			    ...
			    url: 'https://'+ appConfig.domain + '/occupancy',
